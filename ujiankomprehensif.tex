...
%%%%--------------------------------------
%%%% Approval UK --> CHOOSE ONE
%%%%--------------------------------------
%%%% Approval page before Ujian Komprehensif to be signed:
\chapterapproval{contents/approvalpage/approvalbeforeUK}
...
% \phantomsection
% \includepdf[pages={1}]{attachment/signedpromotorUK.pdf}
% \setcounter{page}{4}

%%%% Approval page after revision to be signed:
% \chapterapproval{contents/approvalpage/approvalafterUK}
...
% \addcontentsline{toc}{chapter}{HALAMAN PERSETUJUAN}
% \phantomsection
% \includepdf[pages={1,2}]{attachment/signedhalamanpersetujuanrevisiUK.pdf}
% \setcounter{page}{5}
