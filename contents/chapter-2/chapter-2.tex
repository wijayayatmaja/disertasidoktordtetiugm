...
Alasan pengembangan Markov Chain Monte Carlo pada penelitian disertasi ini dijelaskan melalui performa dari pendekatan stokastik sebelumnya untuk penentuan kapasitas \textit{hosting}, yaitu Monte Carlo, dalam memodelkan penetrasi secara stokastik. Seperti yang telah dijelaskan secara rinci pada subbab sebelumnya pada bab ini, \cite{Epri2012,Dubey2015,Dubey2017,Ding2017,Bollen2017,Torquato2018,Deakin2019,Vergara2020}

Markov Chain Monte Carlo dipilih karena karakteristik solusinya yang dapat melakukan perpindahan dengan probabilitas \textit{states}$-$nya. Lebih dalam lagi, \textit{hidden Markov model} dirancang untuk mengerjakan perpindahan \textit{states} yang salah satu sisinya merupakan \textit{hidden states}, sedangkan \textit{layered hidden Markov model} dirancang untuk mengatasi \textit{states} tingkatan yang lebih tinggi. Selanjutnya, model beban yang tersebar secara individual, kerangka runtun waktu, dan studi sensitivitas merupakan usulan-usulan solusi tambahan untuk meningkatkan akurasi dari pendekatan Markov Chain Monte Carlo yang diusulkan.
