...
\begin{figure}[!h]
	...
	\label{volrise}
\end{figure}
Gambar tersebut mengilustrasikan suatu sumber tenaga listrik yang diwakili oleh gardu induk pada satu sisi. Selanjutnya, pada sisi satunya terdapat suatu sumber lain, yaitu PLTS. Berdasarkan gambar tersebut, daya yang mengalir pada sisi PLTS adalah
\begin{equation}\label{eq:volrise}
...
Untuk memperlihatkan kondisi kenaikan tegangan disisi PLTS, sebuah asumsi berupa nilai nol pada $\theta$ diterapkan ($\theta=0$).
