...
\begin{equation}\label{eq:volrise1}
	...
	\widetilde E_P \Big\{\dfrac{\widetilde E_S - \widetilde E_P}{R+jX}\Big\}^* =
	E_P \Big\{\dfrac{E_S cos\theta + E_P sin\theta - E_P}{R+jX}\Big\}^*,
\end{equation}
sehingga
\begin{equation}\label{eq:volrise2}
	P_P = \dfrac{E_S E_P}{R+jX}sin\theta \ \text{dan}\  P_S = \dfrac{E_S E_P}{R+jX}sin\theta,
\end{equation}
serta
\begin{equation}\label{eq:volrise3}
	Q_P = \dfrac{E_S E_P cos\theta - E_P^2}{R+jX} \ \text{dan}\  Q_S = \dfrac{E_S^2 - E_S E_P cos\theta}{R+jX}.
\end{equation}
...
\begin{equation}\label{eq:volrise5}
	Q_P = \dfrac{E_P(E_S - E_P)}{R+jX} \ \text{dan}\  Q_S = \dfrac{E_S(E_S - E_P)}{R+jX}.
\end{equation}
