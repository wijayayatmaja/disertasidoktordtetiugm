...
%%%%--------------------------------------
%%%% Approval SH1 --> CHOOSE ONE
%%%%--------------------------------------
%%%% Approval page before Seminar Hasil 1 to be signed:
\chapterapproval{contents/approvalpage/approvalbeforeSH1}
...
% \phantomsection
% \includepdf[pages={1}]{attachment/signedpromotorSH1.pdf}
% \setcounter{page}{4}
