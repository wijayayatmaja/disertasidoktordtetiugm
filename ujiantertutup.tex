...
%%%% Penilaian Kelayakan Disertasi (PKD) and Ujian Tertutup
...
%%%%--------------------------------------
%%%% Approval PKD/UT --> CHOOSE ONE
%%%%--------------------------------------
%%%% Approval page before Penilaian Kelayakan Disertasi and Ujian Tertutup to be signed:
\chapterapproval{contents/approvalpage/approvalbeforeUT}

%%%% Approval page before Penilaian Kelayakan Disertasi and Ujian Tertutup signed:
% \clearpage
% \phantomsection
% \addcontentsline{toc}{chapter}{HALAMAN PERSETUJUAN}
% \phantomsection
% \includepdf[pages={1}]{attachment/signedpromotorUT.pdf}
% \setcounter{page}{4}

%%%% Approval page after revision to be signed:
% \chapterapproval{contents/approvalpage/approvalafterUT}

%%%% Approval page after revision signed:
% \clearpage
% \phantomsection
% \addcontentsline{toc}{chapter}{HALAMAN PERSETUJUAN}
% \phantomsection
% \includepdf[pages={1,2}]{attachment/signedhalamanpersetujuanrevisiUT.pdf}
% \setcounter{page}{5}

%%%%--------------------------------------
%%%% Originality statement/plagiarism disclaimer (Pernyataan Promovendus)
%%%%--------------------------------------
%%%% Promovendus to be signed
%%%% Use this for Penilaian Kelayakan Disertasi
\chapterstatement{contents/statement/statement}

%%%% Signed Promovendus
% \clearpage
% \phantomsection
% \addcontentsline{toc}{chapter}{PERNYATAAN PROMOVENDUS}
% \phantomsection
% \includepdf[pages={1}]{attachment/signedpernyataanpromovendus.pdf}
% \setcounter{page}{6}
...
% \phantomsection
% \includepdf[pages={1,2}]{attachment/signedprakata.pdf}
% \setcounter{page}{8}
